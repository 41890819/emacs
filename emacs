...
;=====使某一ecb窗口最大化=====
(define-key global-map [(f1)] 'ecb-maximize-window-directories)
(define-key global-map [(f2)] 'ecb-maximize-window-sources)
(define-key global-map [(f3)] 'ecb-maximize-window-methods)
(define-key global-map [(f4)] 'ecb-maximize-window-history)
